...
RUN="run -it -e LOGLEVEL=trace -e MODE=server -p 9011:8011 -v ./certs/dh4096.pem:/certs/dh4096.pem:ro -v ./certs/ca.crt:/certs/ca.crt:ro -v ./certs/private.key:/certs/private.key:ro -v ./certs/certificate.crt:/certs/certificate.crt:ro localhost/ssf:3.0.0"
which podman
